...
public class SauceDemoTests extends BaseTest {
    ...
    public void invalidUserTest() {
        ...
        Logs.info("Waiting for the login page to be displayed");
        final var loginInput = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("user-name")));

        Logs.info("Writing the username");
        loginInput.sendKeys("locked_out_user");
    ...
    public void validUserTest() {
        ...
        Logs.info("Waiting for the shopping page to be displayed");
    ...
    public void itemDetailTest() {
        ...
        Logs.info("Waiting for the inventory details page to be displayed");
        final var inventoryName = wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("inventory_details_name")));
    ...
    public void logoutTest() {
        ...
        Logs.info("Waiting for the login page to be displayed");
        final var loginInput = wait.until(ExpectedConditions.visibilityOfElementLocated(userNameLocator));
